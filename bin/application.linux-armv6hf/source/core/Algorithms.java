...
public class Algorithms {
     ...
     */
    public void run( AlgorithmBase _algo, Point snakeHead, ArrayList<Point> snakeParts, Point applePos ) {
        // Find the algorithm
        for (int i = 0; i < algorithms.length; i++) {
            if (_algo == algorithms[i]) {
                ...
                // Send information to the algorithm if it wants to use it
                algorithms[i].update( snakeHead, snakeParts, applePos );
